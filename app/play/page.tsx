  ...
  return (
    <main className="min-h-screen bg-background text-foreground pb-20 lg:pb-0">
      <div className="mx-auto flex min-h-screen w-full max-w-[1440px] flex-col px-4 sm:px-6 py-4 sm:py-6">
        ...
        <footer className="border-t py-4 text-xs text-center sm:text-left mb-16 lg:mb-0" style={{ borderColor: '#2F3355', color: '#8B8FAD' }}>
          Built for fast minds, powered by <span style={{ color: '#E9B213' }}>Nimiq</span>.
        </footer>
      </div>
